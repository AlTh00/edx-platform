    ...
    function(Backbone, _, gettext, ValidationHelpers, DateUtils) {
        ...
        // A bit funny in that the video key validation is asynchronous; so, it won't stop the validation.
            ...
            newattrs, ['start_date', 'end_date', 'certificate_available_date', 'enrollment_start', 'enrollment_end']
                ...
                if (newattrs.start_date && newattrs.certificate_available_date && newattrs.start_date > newattrs.certificate_available_date) {
                    errors.enrollment_start = gettext('The certificate available date must be later than the enrollment start date.');
                }
